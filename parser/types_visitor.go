...
type TypesVisitor interface {
	...
	// Visit a parse tree produced by TypesParser#NamedSingle.
	VisitNamedSingle(ctx *NamedSingleContext) interface{}
	...
	// Visit a parse tree produced by TypesParser#Parenthesized.
